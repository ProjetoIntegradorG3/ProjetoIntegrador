package com.daterra.projetoint.service;
...
import com.daterra.projetoint.model.UsuarioLogin;
import com.daterra.projetoint.repository.UsuarioRepository;
...
public class UsuarioService {
	...
	public Optional<Usuario> atualizarUsuario(Usuario usuario) {
		...
		if (usuarioRepository.findById(usuario.getId()).isPresent()) {
			Optional<Usuario> buscarUsuario = usuarioRepository.findByLogin(usuario.getLogin());
	...
	public Optional<UsuarioLogin> logarUsuario(Optional<UsuarioLogin> usuarioLogin) {
		...
		if (usuario.isPresent()) {
			if (compararSenhas(usuarioLogin.get().getSenha(), usuario.get().getSenha())) {
				...
				usuarioLogin.get()
						.setToken(gerarBasicToken(usuarioLogin.get().getLogin(), usuarioLogin.get().getSenha()));
